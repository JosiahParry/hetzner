...
Create a new API key following [Hetzners instruction's](https://docs.hetzner.cloud/reference/hetzner).
...
Restart your R session. All functions will use this `HETZNER_API_KEY` environment variable to perform Bearer authentication via httr2. 
